...
<body class="home">
    ...
    <!-- Slider -->
    <div class="SliderDivParent">
        <div class="slider">
            <div class="slide active">
                <img src="./assets/images/Slider/oil-1.jpg" alt="" class="imgC">
                <!-- <div class="info">
                    <p>hello wolrd</p>
                </div> -->
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-3.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-4.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-6.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil_8.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-9.jpg" alt="" class="imgC">
            </div>
            <div class="slide">
                <img src="./assets/images/Slider/oil-culti.jpg" alt="" class="imgC">
            </div>
            ...
            <div class="navigation-visibility" id="dots">
    ...
    <div class="AbtDivmDiv">
        <div class="AbtDivmDivChild">
            <div class="AboutPlamMDiv">
                <div class="AbtDiv">
                    <h2>Introduction <b>&#8595</b></h2>
                    <div class="line-bar1">....</div>
                    <br>
                    <p class="AbtDivPTag">Among all perennial crops, Oil palm crop is one of the highest oil yielding crops.
                        The edible palm oil and palm kernel oil are both produced by the oil palm tree. Because of its high
                        yielding capacity, this oil palm is known as the golden palm.
                        Palm oil can be harvested throughout the year. After reaching the age of 5 years, oil palm can produce
                        20-25 MT fresh fruit bunches (FFB) per hectare with good planting material, irrigation, and correct
                        management. In comparative terms, yield
                        of palm oil is 5 times the yield of edible oil obtainable from traditional oilseeds. Millions of people
                        and their families rely on oil palm agriculture and processing for survival. India currently produces
                        palm oil on more than 3,00,000 hectares
                        of land and plans to cover an additional area of 6,50,000 hectares by 2025-26. India is the world's
                        largest palm oil importer heavily dependent on Malaysia and Indonesia to meet about 60 percent of its
                        annual needs.
                ...
                <div class="AboutPlamImgDiv">
                    <img src="./assets/images/Rectangle.png" alt="" class="imgInroTag">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mapMDiv">
        <div class="bgnew">
            <p></p>
            <H2 class="mapd">Potential States and Districts</h2>
            ...
            <div class="rowmapDiv">
                ...
                <div class="bgmapdet">
                    <div class="mapdetail">
                        <div class="mapdetailChild">
                            <div class="table">

                                <div class="row header">
                                    <div class="cell tableTitle">
                                        Potential State
                                    </div>
                                    <div class="cell tableTitle">
                                        Potential District
